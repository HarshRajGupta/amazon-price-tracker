...
1. **Clone the repository**
   ...
   ```bash
   git clone https://github.com/HarshRajGupta/amazon-price-tracker.git
   ```
...
Please note that the project requires the "m.media-amazon.com" domain to be accessible for image handling. If you are unable to access this domain, you may encounter issues with image loading.# amazon-price-tracker
